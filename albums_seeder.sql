...
INSERT INTO albums (artist, name_of_record, release_date, genre, sales)
...
INSERT INTO albums (artist, name_of_record, release_date, genre, sales)
VALUES ('Kid Cudi', 'Man on the Moon II: The Legend of Mr. Rager', 2009, 'Hip-hop', 23.7);

INSERT INTO albums (artist, name_of_record, release_date, genre, sales)
VALUES ('Drake', 'Take Care', 2011, 'Hip-hop', 37.2);

INSERT INTO albums (artist, name_of_record, release_date, genre, sales)
VALUES ('Bad Bunny', 'YHLQMDLG', 2020, 'Hip-hop, Latin, Reggaeton', 25.8);
...
VALUES ('Michael Jackson', 'Thriller', 1982, 'Pop, Rock, R&B', 47.3),
       ...
       ('Kid Cudi', 'Man on the Moon II: The Legend of Mr. Rager', 2009, 'Hip-hop', 23.7),
       ('Drake', 'Take Care', 2011, 'Hip-hop', 37.2),
       ('Bad Bunny', 'YHLQMDLG', 2020, 'Hip-hop, Latin, Reggaeton', 25.8);
